...
($context["required"] ?? null)) ? ("form-required") : (""))];
        ...
        // line 40
        echo "  <legend";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["legend"] ?? null), "attributes", []), "html", null, true));
        echo ">
    <span";
        // line 41
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute(($context["legend_span"] ?? null), "attributes", []), "addClass", [0 => ($context["legend_span_classes"] ?? null)], "method"), "html", null, true));
        echo ">";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["legend"] ?? null), "title", []), "html", null, true));
        echo "</span>
  </legend>
...
";
    ...
    {
        return new Twig_Source("", "core/themes/classy/templates/form/fieldset.html.twig", "/var/www/drupaltest/htdocs/core/themes/classy/templates/form/fieldset.html.twig");
    }
}
