...
class __TwigTemplate_d9ba33b419251a129f0079229881e5a0ab1a02fe7c82104a8bcd03827f78045b extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if ($this->getAttribute(($context["context"] ?? null), "list_style", [])) {
            // line 23
            $context["wrapper_attributes"] = $this->getAttribute(($context["wrapper_attributes"] ?? null), "addClass", [0 => ("item-list--" . $this->getAttribute(($context["context"] ?? null), "list_style", []))], "method");
            // line 24
            $context["attributes"] = $this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => ("item-list__" . $this->getAttribute(($context["context"] ?? null), "list_style", []))], "method");
        }
        // line 26
        if ((($context["items"] ?? null) || ($context["empty"] ?? null))) {
            // line 27
            echo "<div";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["wrapper_attributes"] ?? null), "addClass", [0 => "item-list"], "method"), "html", null, true));
            echo ">";
            // line 28
    ...
    {
        return new Twig_Source("", "core/themes/classy/templates/dataset/item-list.html.twig", "/var/www/drupaltest/htdocs/core/themes/classy/templates/dataset/item-list.html.twig");
    }
}
