...
$context["item"], "text_attributes", [])) {
                    // line 48
                    echo "<span";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["item"], "text_attributes", []), "html", null, true));
                    echo ">";
    ...
    {
        return new Twig_Source("", "core/themes/classy/templates/navigation/links.html.twig", "/var/www/drupaltest/htdocs/core/themes/classy/templates/navigation/links.html.twig");
    }
}
