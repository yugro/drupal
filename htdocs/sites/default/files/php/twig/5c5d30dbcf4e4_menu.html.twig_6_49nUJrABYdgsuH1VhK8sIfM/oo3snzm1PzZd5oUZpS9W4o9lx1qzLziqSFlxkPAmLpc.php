        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => "menu"], "method"), "html", null, true));
                    echo ">
    ";
                } else {
                    // line 35
...
$context["item"], "in_active_trail", [])) ? ("menu-item--active-trail") : (""))];
  ...
  ";
    ...
    {
        return new Twig_Source("", "core/themes/classy/templates/navigation/menu.html.twig", "/var/www/drupaltest/htdocs/core/themes/classy/templates/navigation/menu.html.twig");
    }
}
