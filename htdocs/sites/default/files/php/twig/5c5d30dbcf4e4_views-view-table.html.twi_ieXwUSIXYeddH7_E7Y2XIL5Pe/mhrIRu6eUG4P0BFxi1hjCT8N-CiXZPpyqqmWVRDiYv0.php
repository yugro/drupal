...
class __TwigTemplate_14296e1bbcce1e7c5f12b19ab1ca6ccd0e16f6df1d1936d532fc5aac3033516e extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 34
        $context["classes"] = [0 => "views-table", 1 => "views-view-table", 2 => ("cols-" . twig_length_filter($this->env,         // line 37
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["key"] => $context["column"]) {
                ...
                if ($this->getAttribute($context["column"], "default_classes", [])) {
                    ...
                    echo "            ";
                    // line 68
                    $context["column_classes"] = [0 => "views-field", 1 => ("views-field-" . $this->getAttribute(                    // line 70
($context["fields"] ?? null), $context["key"], [], "array"))];
                ...
                // line 74
                echo "          <th";
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($context["column"], "attributes", []), "addClass", [0 => ($context["column_classes"] ?? null)], "method"), "setAttribute", [0 => "scope", 1 => "col"], "method"), "html", null, true));
                echo ">";
                // line 75
                if ($this->getAttribute($context["column"], "wrapper_element", [])) {
                    // line 76
                    echo "<";
                    echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["column"], "wrapper_element", []), "html", null, true));
                    echo ">";
                    // line 77
                    if ($this->getAttribute($context["column"], "url", [])) {
                        // line 78
                        echo "<a href=\"";
                        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["column"], "url", []), "html", null, true));
                        echo "\" title=\"";
                        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["column"], "title", []), "html", null, true));
                        echo "\">";
                        ...
                        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["column"], "sort_indicator", []), "html", null, true));
                        echo "</a>";
                    } else {
                        // line 80
                        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["column"], "content", []), "html", null, true));
            ...
            foreach ($context['_seq'] as $context["key"] => $context["column"]) {
                ...
                if ($this->getAttribute($context["column"], "default_classes", [])) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                        // line 106
                        echo "              ";
                        $context["column_classes"] = twig_array_merge(($context["column_classes"] ?? null), [0 => ("views-field-" . $context["field"])]);
                        // line 107
                        echo "            ";
                    }
                    $_parent = $context['_parent'];
                ...
                // line 109
                echo "          <td";
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($context["column"], "attributes", []), "addClass", [0 => ($context["column_classes"] ?? null)], "method"), "html", null, true));
                echo ">";
                // line 110
                if ($this->getAttribute($context["column"], "wrapper_element", [])) {
                    // line 111
              ...
              ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["content"]) {
                        // line 113
                        echo "                ";
                        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["content"], "separator", []), "html", null, true));
                        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($context["content"], "field_output", []), "html", null, true));
                        echo "
              ";
                    }
                    $_parent = $context['_parent'];
...
";
    ...
    {
        return new Twig_Source("", "core/themes/classy/templates/views/views-view-table.html.twig", "/var/www/drupaltest/htdocs/core/themes/classy/templates/views/views-view-table.html.twig");
    }
}
